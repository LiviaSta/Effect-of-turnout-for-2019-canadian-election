...
raw_data <- read_csv("C:/Users/livia/Desktop/school/sta304/ps2/AAc19Kmr.csv")
dict <- read_lines("C:/Users/livia/Desktop/school/sta304/ps2/gss_dict.txt", skip = 18) # skip is because of preamble content
# Now we need the labels because these are the actual responses that we need
labels_raw <- read_file("C:/Users/livia/Desktop/school/sta304/ps2/gss_labels.txt")
